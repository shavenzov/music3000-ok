package components.library.looperman
{
	...
	public class AsyncLoopermanCollection extends PagedList
	{
		...
		public function AsyncLoopermanCollection( _api : LoopermanAPI = null )
		{
			super( 0, LoopermanAPI.DEFAULT_PAGE_SIZE );
			
			if ( _api ) api = _api;
			 else api = new LoopermanAPI();
