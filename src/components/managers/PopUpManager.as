...
package components.managers
{
	...
	public class PopUpManager
	{
		 ...
		 */		
		private static var numWindows : int = 0;
		...
		public static function addPopUp( window:IFlexDisplayObject, parent:DisplayObject = null, modal:Boolean = false, childList:String = null ) : void
	     {
			...
			numWindows ++;
			dispatcher.dispatchEvent( new PopUpEvent( PopUpEvent.OPEN, numWindows, window ) );
	     }
	    ...
	    public static function removePopUp( popUp : IFlexDisplayObject ) : void
	     {
			...
			numWindows --;
			dispatcher.dispatchEvent( new PopUpEvent( PopUpEvent.CLOSE, numWindows, popUp ) );
	     }
		...
		public static function removeAllPopUps() : void
		{
			...
			numWindows = 0;
			dispatcher.dispatchEvent( new PopUpEvent( PopUpEvent.CLOSE, numWindows, null ) );
		}
