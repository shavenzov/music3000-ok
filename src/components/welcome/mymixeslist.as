 ...
 */
public var numVisibleProjects : int = 8;
...
public function refresh() : void
{
	if ( currentState != 'updating' )
	{
		...
		MainAPI.impl.addListener( BrowseProjectEvent.BROWSE_PROJECTS, onBrowsedProjects, this );
...
private function onBrowsedProjects( e : BrowseProjectEvent ) : void
{
	...
	if ( OKApi.userInfo.uid == selectedUser.uid )
	{
		header.text = 'Мои последние миксы';
	}
	else
	{
		header.text = 'Последние миксы ' + selectedUser.name;
	}
