...
private function creationComplete() : void
{
	...
	title.textFlow = TextConverter.importToFlow( '<b>' + OKApi.userInfo.first_name + '</b>, Добро Пожаловать в Музыкальный Конструктор!', TextConverter.TEXT_FIELD_HTML_FORMAT );
...
private function onGotLimitations( e : LimitationsEvent ) : void
{
	...
	{
		currentState = 'normal';
		HintManager.show( LimitationsEvent.getErrorDescription( e.projectsErrorCode, true ), true, newMixButton, true );
	}
	else
	{
