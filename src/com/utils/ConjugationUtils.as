package com.utils
{
	public class ConjugationUtils
	{
		...
		public static function formatOKMoney( numOK : int ) : String
		{
			return format( numOK, 'OK', 'OK', 'OK' );
		}
		...
		/**
		 * Возвращает идентификатор монеты 
		 * @param numCoins
		 * @return 
		 * 
		 */		
		public static function getCoinsIndentifier( numCoins : int ) : String
		{
			return 'coins_' + numCoins.toString();
		}
