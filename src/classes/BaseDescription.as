package classes
{
	...
	public class BaseDescription implements IXMLSerializable
	{
		...
		public function BaseDescription( id : String, hqurl : String, lqurl : String, name : String, author : String, duration : Number, bpm : Number, key : String, genre : String, category : String, loop : Boolean )
		{
			this.id = id;
			this.hqurl = hqurl;
			this.lqurl = lqurl;
