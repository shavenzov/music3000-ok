package classes
{
	...
	public class SequencerImplementation extends EventDispatcher
	{
		...
		*/
		 ...
		 * 
		 */		
		public function getPlayingArea() : Object
		{
		 ...
		 * 
		 */		
		public function beginMixDown() : Number
		{	
			if ( _mixdown )
			...
			var playingArea : Object = getPlayingArea();
			
			var length : Number = AudioData.framesToBytes( playingArea.length );
			
			lastPosition = _position;
			
			position = playingArea.from;
