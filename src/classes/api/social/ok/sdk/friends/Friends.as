package classes.api.social.ok.sdk.friends
{
	...
	public class Friends 
	{
		...
		public static function areFriends(uids1:Array, uids2:Array, callback:Function):void {
			OKApi.callRestApi("friends.areFriends", callback, { uids1:uids1.join(","), uids2:uids2.join(",") } );
		}
		...
		public static function get(callback:Function, uid:String):void {
			OKApi.callRestApi("friends.get", callback, OKApi.getSendObject({ uid:uid }) );
		}
		...
		public static function getAppUsers(callback:Function):void {
			OKApi.callRestApi("friends.getAppUsers", callback );
		}
		...
		public static function getBirthdays(callback:Function, uid:String = "", future:Boolean = true):void {
			OKApi.callRestApi("friends.getBirthdays", callback, OKApi.getSendObject({uid:uid, future:future}) );
		}
		...
		public static function getMutualFriends(target_id:String, callback:Function, source_id:String = ""):void {
			OKApi.callRestApi("friends.getMutualFriends", callback, OKApi.getSendObject({target_id:target_id, source_id:source_id}) );
		}
		...
		public static function getOnline(callback:Function, uid:String = "", online:String = ""):void {
			OKApi.callRestApi("friends.getOnline", callback, OKApi.getSendObject({uid:uid, online:online}) );
		}
