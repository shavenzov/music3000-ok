package classes.api.social.ok.sdk.widget 
{
	...
	public class Widget 
	{
		...
		{
			OKApi.callRestApi("widget.getWidgets", callback, { wids:wids.join(",")} );
		}
		...
		{
			OKApi.callRestApi("widget.getWidgetContent", callback, { wid:wid}, "XML" );
		}
