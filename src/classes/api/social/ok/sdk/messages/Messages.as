package classes.api.social.ok.sdk.messages
{
	...
	public class Messages 
	{
		...
		public static function getConversations(callback:Function, last_check:String = "", return_last_msg:Boolean = false):void {
			OKApi.callRestApi("messages.getConversations", callback, OKApi.getSendObject({last_check:last_check, return_last_msg:return_last_msg}) );
		}
		...
		public static function getList(friend_uid:String, first:int, count:int, callback:Function, txt_limit:String = ""):void {
			OKApi.callRestApi("messages.getList", callback, OKApi.getSendObject({friend_uid:friend_uid, first:first, count:count, txt_limit:txt_limit}) );
		}
		...
		public static function get(msg_id:String, callback:Function):void {
			OKApi.callRestApi("messages.get", callback, {msg_id:msg_id} );
		}
		...
		public static function send(friend_uid:String, text:String, callback:Function, uid:String = ""):void {
			OKApi.callRestApi("messages.send", callback, OKApi.getSendObject({uid:uid, friend_uid:friend_uid, text:text}) );
		}
		...
		public static function markAsRead(msg_id:String, callback:Function):void {
			OKApi.callRestApi("messages.markAsRead", callback, {msg_id:msg_id} );
		}
		...
		public static function markAsSpam(msg_ids:Array, callback:Function):void {
			OKApi.callRestApi("messages.markAsSpam", callback, {msg_ids:msg_ids.join(",")} );
		}
		...
		public static function messagesDelete(msg_ids:Array, callback:Function):void {
			OKApi.callRestApi("messages.delete", callback, {msg_ids:msg_ids.join(",")} );
		}
	}
