package classes.api.social.ok.sdk.discussions
{
	...
	public class Discussions 
	{
		...
		public static function getDiscussions(callback:Function, entityTypes:Array = null, offset:int = 0, count:int = 10):void {
			OKApi.callRestApi("discussions.getDiscussions", callback, OKApi.getSendObject({entityTypes:((entityTypes) ? entityTypes.join(",") : ""), offset:offset, count:count}) );
		}
		...
		public static function getDiscussionCommentsCount(entityType:String, entityId:String, callback:Function):void {
			OKApi.callRestApi("discussions.getDiscussionCommentsCount", callback, {entityType:entityType, entityId:entityId} );
		}
		...
		public static function addDiscussionComment(entityType:String, entityId:String, comment:String, callback:Function):void {
			OKApi.callRestApi("discussions.addDiscussionComment", callback, {entityType:entityType, entityId:entityId, comment:comment} );
		}
		...
		public static function deleteDiscussionComment(entityType:String, entityId:String, conversationId:Number, messageIndex:Number, callback:Function):void {
			OKApi.callRestApi("discussions.deleteDiscussionComment", callback, {entityType:entityType, entityId:entityId, conversationId:conversationId, messageIndex:messageIndex } );
		}
		...
		public static function getDiscussionComments(entityType:String, entityId:String, callback:Function, offset:int = 0, count:int = 0):void {
			OKApi.callRestApi("discussions.getDiscussionComments", callback, OKApi.getSendObject({entityType:entityType, entityId:entityId, offset:offset, count:count }) );
		}
		...
		public static function markDiscussionAsRead(entityType:String, entityId:String, callback:Function):void {
			OKApi.callRestApi("discussions.markDiscussionAsRead", callback, {entityType:entityType, entityId:entityId} );
		}
	}
