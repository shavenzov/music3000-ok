package classes.api.social.ok.sdk.photos
{
	import com.adobe.serialization.json.JSON;
	import classes.api.social.ok.OKApi;
	import classes.api.social.ok.sdk.errors.Errors;
	/**
	 * ...
	...
	public class Photos 
	{
		...
		public static function getUploadUrl(callback:Function, uid:String = "", aid:String = ""):void {
			OKApi.callRestApi("photos.getUploadUrl", callback, OKApi.getSendObject({ uid:uid, aid:aid }) );
		}
		...
		public static function upload(files:Array, callback:Function, url:String = "", uid:String = "", aid:String = "", photos:Array = null):void {
			...
			OKApi.callRestApi("photos.upload", callback, send_obj, 'JSON', "POST", url);
		}
		...
		public static function createAlbum(title:String, type:String, callback:Function, description:String = ""):void {
			...
			OKApi.callRestApi("photos.createAlbum", callback, OKApi.getSendObject({ title:title, type:type, description:description}) );
		}
		...
		public static function getAlbums(callback:Function, uid:String = "", fid:String = "", pagingAnchor:String = "", pagingDirection:String = "", count:int = 0, detectTotalCount:Boolean = false):void {
			OKApi.callRestApi("photos.getAlbums", callback, OKApi.getSendObject({ uid:uid, fid:fid, pagingAnchor:pagingAnchor, pagingDirection:pagingDirection, count:count, detectTotalCount:detectTotalCount}) );
		}
		...
		public static function getPhotoMarks(callback:Function, pagingAnchor:String = "", pagingDirection:String = "", count:int = 0, detectTotalCount:Boolean = false):void {
			OKApi.callRestApi("photos.getPhotoMarks", callback, OKApi.getSendObject({ pagingAnchor:pagingAnchor, pagingDirection:pagingDirection, count:count, detectTotalCount:detectTotalCount}) );
		}
		...
		public static function getUserPhotos(callback:Function, uid:String = "", fid:String = "", pagingAnchor:String = "", pagingDirection:String = "", count:int = 0, detectTotalCount:Boolean = false):void {
			OKApi.callRestApi("photos.getUserPhotos", callback, { uid:uid, fid:fid, pagingAnchor:pagingAnchor, pagingDirection:pagingDirection, count:count, detectTotalCount:detectTotalCount} );
		}
		...
		public static function getUserAlbumPhotos(aid:String, callback:Function, uid:String = "", pagingAnchor:String = "", pagingDirection:String = "", count:int = 0, detectTotalCount:Boolean = false):void {
			OKApi.callRestApi("photos.getUserAlbumPhotos", callback, OKApi.getSendObject({aid:aid, uid:uid, pagingAnchor:pagingAnchor, pagingDirection:pagingDirection, count:count, detectTotalCount:detectTotalCount}) );
		}
	}
